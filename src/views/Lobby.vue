  ...
  <b-container fluid class="h-100">
    <b-row class="main-row">
      <b-col cols="12" lg="3" class="code-col d-none d-lg-block">
        <div class="code-div">
          ...
          <div class="code-p">
            <p>Go to {{this.domain}} and enter this code to join the game.</p>
          </div>
        </div>
      </b-col>
      ...
      <b-col cols="12" lg="9" style="min-height: calc((100% - 152px) - 150px)">
        <b-row class="players-row" id="player-row">
          ...
          <b-col cols="12" lg="6" style="max-width: 50%">
            <h3 style="float: right;">Total: {{players.length}}</h3>
          </b-col>
        </b-row>
    ...
    <b-row class="bottom-row">
      <b-col cols="12" lg="10" class="d-none d-lg-block">
        <div class="code-link">
          <span>{{this.domain}}/{{this.$route.params.code}}</span>
        </div>
      </b-col>
      <b-col cols="12" lg="2">
        <div class="button">
          <b-button variant="success" @click.prevent="startGame">Start</b-button>
        </div>
      </b-col>
    </b-row>
  </b-container>
        ...
        thisDiv.style.top =
          Math.round(
            this.getRandomNumber(
              rowHeight + divs[i].offsetHeight / 2 + 15,
              winHeight - divs[i].offsetHeight / 2 - 15
            )
          ) + "px";
        thisDiv.style.left =
          Math.round(
            this.getRandomNumber(
              0 + divs[i].offsetWidth,
              winWidth - divs[i].offsetWidth
            )
          ) + "px";
      }
    },
    ...
    .code-div {
      ...
      .code-span {
        ...
        span {
          ...
          line-height: 9rem;
          letter-spacing: 0;
          text-shadow: 1px 1px 0px darkred, 2px 2px 0px darkred,
            3px 3px 0px darkred, 4px 4px 0px darkred;
        }
      }
      .code-p {
        flex: 1 1 auto;
